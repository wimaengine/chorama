...
const meshBuilder = new TorusKnotMeshBuilder()
meshBuilder.radius = 0.52
meshBuilder.knotRadius = 0.18
meshBuilder.tubeRadius = 0.055
meshBuilder.p = 2
meshBuilder.q = 3
meshBuilder.radialSegments = 10
meshBuilder.pathSegments = 240
...
buildOptionsFolder
  .add(meshBuilder, "knotRadius", 0, 1, 0.001)
  .name("Knot Radius")
  .onFinishChange(buildMesh)
buildOptionsFolder
  .add(meshBuilder, "tubeRadius", 0, 0.5, 0.001)
  .name("Tube Radius")
  .onFinishChange(buildMesh)
buildOptionsFolder
  .add(meshBuilder, "p", 1, 10, 1)
  .name("P")
  .onFinishChange(buildMesh)
buildOptionsFolder
  .add(meshBuilder, "q", 1, 10, 1)
  .name("Q")
  .onFinishChange(buildMesh)
buildOptionsFolder
  .add(meshBuilder, "radialSegments", 3, 64, 1)
  .name("Radial Segments")
  .onFinishChange(buildMesh)
buildOptionsFolder
  .add(meshBuilder, "pathSegments", 8, 512, 1)
  .name("Path Segments")
  .onFinishChange(buildMesh)
buildOptionsFolder

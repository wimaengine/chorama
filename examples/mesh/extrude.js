...
const meshBuilder = new ExtrudeMeshBuilder()
meshBuilder.contour = [
  new Vector2(-0.55, -0.45),
  new Vector2(0.2, -0.45),
  new Vector2(0.2, -0.2),
  new Vector2(0.55, -0.2),
  new Vector2(0.55, 0.25),
  new Vector2(0.12, 0.25),
  new Vector2(0.12, 0.55),
  new Vector2(-0.55, 0.55)
]
meshBuilder.depth = 0.7

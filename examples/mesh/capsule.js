...
const meshBuilder = new CapsuleMeshBuilder()
meshBuilder.radius = 0.35
meshBuilder.height = 1.7
meshBuilder.segments = 24
meshBuilder.profileSegments = 8
...
buildOptionsFolder
  ...
  .onFinishChange(buildMesh)
buildOptionsFolder
  .add(meshBuilder, "segments", 3, 64, 1)
  .name("Segments")
  .onFinishChange(buildMesh)
buildOptionsFolder
  .add(meshBuilder, "profileSegments", 1, 32, 1)

...
const meshBuilder = new HelixMeshBuilder()
meshBuilder.radius = 0.45
meshBuilder.tubeRadius = 0.055
meshBuilder.turns = 4
meshBuilder.height = 1.95
meshBuilder.radialSegments = 10
meshBuilder.pathSegments = 160
...
buildOptionsFolder
  .add(meshBuilder, "radius", 0.1, 2, 0.01)
  .name("Radius")
  .onFinishChange(buildMesh)
buildOptionsFolder
  .add(meshBuilder, "tubeRadius", 0.01, 0.5, 0.001)
  .name("Tube Radius")
  .onFinishChange(buildMesh)
buildOptionsFolder
  .add(meshBuilder, "turns", 1, 12, 1)
  .name("Turns")
  .onFinishChange(buildMesh)
buildOptionsFolder
  .add(meshBuilder, "height", 0.1, 6, 0.01)
  .name("Height")
  .onFinishChange(buildMesh)
buildOptionsFolder

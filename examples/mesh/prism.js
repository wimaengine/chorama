...
const meshBuilder = new PrismMeshBuilder()
meshBuilder.sides = 7
meshBuilder.radius = 0.44
meshBuilder.depth = 0.9
meshBuilder.rotation = Math.PI / 7
...
buildOptionsFolder
  ...
  .onFinishChange(buildMesh)
buildOptionsFolder
  .add(meshBuilder, "rotation", 0, Math.PI * 2, 0.01)
  .name("Rotation")
  .onFinishChange(buildMesh)
buildOptionsFolder
